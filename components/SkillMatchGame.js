...
export default function SkillMatchGame({ language, hardSkills, technologyColors }) {
  ...
  const softSkills = french
    ? [['Résolution de problèmes', 'Transformer la complexité en solutions concrètes.'], ['Créativité', 'Imaginer des expériences utiles qui marquent.'], ['Communication', 'Rendre les idées claires et accessibles.'], ['Esprit d’équipe', 'Construire avec écoute, confiance et partage.'], ['Leadership & organisation', 'Coordonner un événement et donner de l’énergie à une équipe.'], ['Adaptabilité', 'Apprendre vite et évoluer avec le contexte.'], ['Public Speaking', 'Prendre la parole avec clarté, confiance et impact.']]
    : [['Problem solving', 'Turning complexity into concrete solutions.'], ['Creativity', 'Imagining useful experiences that leave a mark.'], ['Communication', 'Making ideas clear and accessible.'], ['Team spirit', 'Building through trust and active listening.'], ['Leadership & organisation', 'Coordinating an event and energising a team.'], ['Adaptability', 'Learning fast and evolving with context.'], ['Public Speaking', 'Speaking with clarity, confidence and impact.']];
