...
const hardSkills = {
  ...
  Tools: [{ name: 'Git', icon: <SiGit /> }, { name: 'Docker', icon: <SiDocker /> }, { name: 'Figma', icon: <SiFigma /> }, { name: 'Canva', icon: <SiCanva /> }, { name: 'Power BI', icon: <FaChartBar /> }, { name: 'Postman', icon: <SiPostman /> }, { name: 'Linux', icon: <SiLinux /> }],
